package com.xuhao.contactindex.ui;
...
public class QuickIndexBar extends View {
    ...
    private void init() {
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);//参数意思为抗锯齿
        mPaint.setColor(Color.WHITE);//画笔颜色-白色
        mPaint.setTypeface(Typeface.DEFAULT_BOLD);//设置字体样式加粗
