package com.xuhao.contactindex.adapter;
...
import com.xuhao.contactindex.R;
 ...
 * Date: 2016/5/4  16:58
 */
public class GoodManAdapter extends BaseAdapter {
    private Context mContext;
    private ArrayList<Person> persons;

    public GoodManAdapter(Context mContext, ArrayList<Person> persons) {
